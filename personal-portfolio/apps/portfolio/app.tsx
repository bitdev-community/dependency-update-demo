...
import {
  SettingsProvider,
  SettingsConsumer,
} from '@showoff/personal-portfolio.contexts.settings-context';
...
import {
  ...
  SOCIAL_LINKS,
  USER_PROFILE,
} from '@showoff/personal-portfolio.constants.data';
        ...
        <SettingsConsumer>
          {({ theme }) => (
            <ThemeProvider theme={theme === 'dark' ? dark : light}>
              <Main footerProps={FOOTER_META} headerProps={HEADER_LINKS}>
                <Routes>
                  <Route
                    path="/"
                    element={
                  ...
                  />
                  <Route path="/about" element={<AboutPage {...ABOUT_ME} />} />
                  <Route
                    path="/contact"
                    element={
                      <ContactPage
                  ...
                  <Route
                    path="/projects/:id"
                    element={<IndividualProjectPage projectsToUse={PROJECTS} />}
                  />
                </Routes>
              </Main>
            </ThemeProvider>
